    ...
    <div class="menubar-scroll-inner">
      <ul class="app-menu">
        ...
        <li class="has-submenu">
          ...
          <ul class="submenu">
            <li><a href="<?=base_url('assets')?>/default/index.html"><span class="menu-text">Default</span></a></li>
            <li><a href="<?=base_url('assets')?>/topbar/index.html"><span class="menu-text">Topbar</span></a></li>
          </ul>
        </li>
